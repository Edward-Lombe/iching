...
var _user$project$Main$listFrom6tuple = function (_p0) {
	var _p1 = _p0;
	return {
		ctor: '::',
		_0: _p1._0,
...
var _user$project$Main$map6tuple = F2(
	function (fn, _p2) {
		var _p3 = _p2;
		return {
			ctor: '_Tuple6',
...
var _user$project$Main$iChingDecoder = A2(
	...
	_elm_lang$core$Json_Decode$list(
		A2(
			_elm_lang$core$Json_Decode$map,
			_user$project$Main$pattern2hexagram,
			A2(
				_elm_lang$core$Json_Decode$at,
				{
					ctor: '::',
...
var _user$project$Main$ReceiveSize = function (a) {
	return {ctor: 'ReceiveSize', _0: a};
};
var _user$project$Main$subscriptions = function (model) {
	return _elm_lang$window$Window$resizes(_user$project$Main$ReceiveSize);
};
var _user$project$Main$ReceiveIChing = function (a) {
	return {ctor: 'ReceiveIChing', _0: a};
};
var _user$project$Main$init = function () {
	...
	var getIChing = A2(
		...
		_user$project$Main$ReceiveIChing,
		A2(_elm_lang$http$Http$get, _user$project$Main$iChingURL, _user$project$Main$iChingDecoder));
	var effects = _elm_lang$core$Platform_Cmd$batch(
		{
			ctor: '::',
			_0: getSize,
			_1: {
...
if (typeof _user$project$Main$main !== 'undefined') {
    _user$project$Main$main(Elm['Main'], 'Main', {"types":{"unions":{"Dict.LeafColor":{"args":[],"tags":{"LBBlack":[],"LBlack":[]}},"Dict.Dict":{"args":["k","v"],"tags":{"RBNode_elm_builtin":["Dict.NColor","k","v","Dict.Dict k v","Dict.Dict k v"],"RBEmpty_elm_builtin":["Dict.LeafColor"]}},"Dict.NColor":{"args":[],"tags":{"BBlack":[],"Red":[],"NBlack":[],"Black":[]}},"Main.Line":{"args":[],"tags":{"Unbroken":[],"Broken":[]}},"Http.Error":{"args":[],"tags":{"BadUrl":["String"],"NetworkError":[],"Timeout":[],"BadStatus":["Http.Response String"],"BadPayload":["String","Http.Response String"]}},"Result.Result":{"args":["error","value"],"tags":{"Ok":["value"],"Err":["error"]}},"Main.Message":{"args":[],"tags":{"ReceiveIChing":["Result.Result Http.Error Main.IChing"],"NoOp":[],"ReceiveSize":["Window.Size"]}}},"aliases":{"Main.IChing":{"args":[],"type":"List Main.Hexagram"},"Http.Response":{"args":["body"],"type":"{ url : String , status : { code : Int, message : String } , headers : Dict.Dict String String , body : body }"},"Main.Hexagram":{"args":[],"type":"( Main.Line, Main.Line, Main.Line, Main.Line, Main.Line, Main.Line )"},"Window.Size":{"args":[],"type":"{ width : Int, height : Int }"}},"message":"Main.Message"},"versions":{"elm":"0.18.0"}});
}
