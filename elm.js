...
var _user$project$Main$iChingURL = 'https://raw.githubusercontent.com/la11111/willie-modules/master/texts_iching/iching.json';
var _user$project$Main$Model = function (a) {
	return {iChing: a};
};
var _user$project$Main$Unbroken = {ctor: 'Unbroken'};
var _user$project$Main$viewBar = F2(
	function (position, bar) {
		var fill_ = _elm_lang$svg$Svg_Attributes$fill('black');
		var height_ = _elm_lang$svg$Svg_Attributes$height('10');
					...
					_elm_lang$svg$Svg$rect,
					{
						...
						_1: {
							...
							_1: {
								...
								_1: {
									ctor: '::',
									_0: _elm_lang$svg$Svg_Attributes$x('80'),
									_1: {ctor: '[]'}
								}
							}
						}
		...
		var y_ = _elm_lang$svg$Svg_Attributes$y(
			_elm_lang$core$Basics$toString(position * 20));
		var attributes = {
			ctor: '::',
			_0: _elm_lang$svg$Svg_Attributes$width('120'),
			_1: {
...
var _user$project$Main$viewHexagram = F2(
	function (position, hexagram) {
		...
		return A2(
			...
			{
				ctor: '::',
				_0: _elm_lang$svg$Svg_Attributes$width('160'),
				_1: {
					ctor: '::',
...
var _user$project$Main$viewHexagrams = function (model) {
	return A2(
		...
		{
			ctor: '::',
			_0: _elm_lang$svg$Svg_Attributes$width('1280'),
			_1: {
				ctor: '::',
				_0: _elm_lang$svg$Svg_Attributes$height('1280'),
				_1: {ctor: '[]'}
			}
		},
...
var _user$project$Main$pattern2hexagram = function (pattern) {
	...
	if (((((((_p9.ctor === '::') && (_p9._1.ctor === '::')) && (_p9._1._1.ctor === '::')) && (_p9._1._1._1.ctor === '::')) && (_p9._1._1._1._1.ctor === '::')) && (_p9._1._1._1._1._1.ctor === '::')) && (_p9._1._1._1._1._1._1.ctor === '[]')) {
		...
		var _p10 = A2(_elm_lang$core$Debug$log, 'Invalid patter', _p9);
